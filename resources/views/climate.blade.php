...
<html class="no-js" lang="zxx">
		...
		<div class="random-posts section-gap">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
						@foreach ($climate as $climate)
						<main class="axil-content">
							<div class="media post-block post-block__mid m-b-xs-30">
								<a href="{{$climate->source_url}}" class="align-self-center"><img class=" m-r-xs-30"
										src="{{$climate->img_url}}" alt=""></a>
								<div class="media-body">
									<div class="post-cat-group m-b-xs-10">
										<a href="business" class="post-cat cat-btn bg-color-blue-one">news</a>
									</div>
									<h3 class="axil-post-title hover-line hover-line"><a
											href="{{$climate->source_url}}">{{$climate->title}}</a></h3>
									<p class="mid">{{$climate->description}}<maxlength="10"/p>
